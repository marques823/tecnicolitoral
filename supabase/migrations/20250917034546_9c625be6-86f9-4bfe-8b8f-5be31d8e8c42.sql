-- Corrigir trigger de notificação para remover referência ao campo updated_by que não existe
DROP TRIGGER IF EXISTS notify_ticket_changes_trigger ON public.tickets;
DROP FUNCTION IF EXISTS public.notify_ticket_changes();

-- Recriar função sem o campo updated_by
